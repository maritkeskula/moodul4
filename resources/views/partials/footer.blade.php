<footer>
    <!-- footer has width100% background color so div container goes inside footer for centering -->
    <div class="container">
        <div class="footer-logo-and-links">
            ...
            <div class="footer-links">
                ...
                <div class="footer-social-icons">
                    ...
                    <a id="footer-facebook" href="facebook.com"></a>
                    <a id="footer-twitter" href="twitter.com"></a>
                </div>
            </div>
        </div>
...
<section class="copyright">
    <p>© 2024 Golden Fighters. All rights reserved.</p>
</section>
